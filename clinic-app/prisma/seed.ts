...
async function main() {
  ...
  const doctors = [
    ...
    { code: 10, name: "HEMANTH", commissionPercent: 50, tdsPercent: 5.1, designationId: 1, isConsultant: true, specialty: "General" },
    { code: 16, name: "VIVEK", commissionPercent: 60, tdsPercent: 5.1, designationId: 1, isConsultant: true, specialty: "Periodontist" },
    { code: 17, name: "RATHIKA RAI", commissionPercent: 25, tdsPercent: 5.15, designationId: 1, isConsultant: true, specialty: "Pedodontist" },
    { code: 21, name: "GIRISH KADRI", commissionPercent: 45, tdsPercent: 5.1, designationId: 1, isConsultant: true, specialty: "Oral Surgeon" },
    { code: 28, name: "GAUTAM", commissionPercent: 50, tdsPercent: 11.33, designationId: 1, isConsultant: true, specialty: "Endodontist" },
    { code: 31, name: "MADHU", commissionPercent: 50, tdsPercent: 11.33, mobile: "9849553445", designationId: 1, isConsultant: true, specialty: "General" },
    { code: 35, name: "BHADRA RAO", commissionPercent: 0, commissionRate: 750, tdsPercent: 11.33, designationId: 1, isConsultant: true, specialty: "Prosthodontist" },
